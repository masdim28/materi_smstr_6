...
3. Buka FileZilla dan masukkan data berikut:
   ...
   - Port: 22
   - Klik Connect
     ![alt text](<Screenshot 2026-03-27 162439.png>)
     ![alt text](<Screenshot 2026-03-27 162640.png>)
...
6. Ubah Hak Akses Folder Web Services Area
   ...
   - cek kembali hak akses folder dengan command (ls -l /var/www/html)
     ![alt text](<Screenshot 2026-03-27 170619.png>)
     ![alt text](<Screenshot 2026-03-27 164244.png>)
7. kita lakukan editing di file index.html setelah hak akses folder sudah diubah
   ![alt text](<Screenshot 2026-03-27 175605.png>)
8. Pastikan Design Responsive
   ![alt text](<Screenshot 2026-03-27 175705.png>)
