...
- Cek Docker -> systemctl status docker
  ![alt text](<Screenshot 2026-05-08 093815.png>)
...
- Simpan token jangan sampai hilang
  ![alt text](<Screenshot 2026-05-08 095002.png>)
...
- Push ke Github
  ![alt text](<Screenshot 2026-05-08 101702.png>)
...
- AWS_HOST isi public IP EC2 AWS kamu
  ![alt text](<Screenshot 2026-05-08 102921.png>)
...
- Isi Dockerfile dengan kode berikut:
  ...
  ![alt text](<Screenshot 2026-05-08 103606.png>)
...
- Isi deploy.yml dengan kode berikut:
  ![alt text](<Screenshot 2026-05-08 104944.png>)
...
![alt text](<Screenshot 2026-05-08 111821.png>)
